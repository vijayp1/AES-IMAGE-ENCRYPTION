...
public class decryption {
	...
	public static String[][] decrypt(String inpt,String[][] state){
	...
	public static void main(String args[])throws Exception {
      ...
      File file= new File("G:/assignment/sem 5/ISAA/PROJECT/New folder/sample.jpg");
      ...
      file = new File("G:/assignment/sem 5/ISAA/PROJECT/New folder/test.jpg");
